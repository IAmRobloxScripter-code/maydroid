...
uninstall:
	rm -f $(INSTALL_BIN_DIR)/maydroid
	rm -rf $(INSTALL_WAYDROID_DIR)
	rm -f $(INSTALL_DBUS_DIR)/system.d/id.waydro.Container.conf
	rm -f $(INSTALL_POLKIT_DIR)/actions/id.waydro.Container.policy
	rm -f $(INSTALL_SYSD_DIR)/waydroid-container@.service
	rm -f $(INSTALL_DBUS_DIR)/system-services/id.waydro.Container.service